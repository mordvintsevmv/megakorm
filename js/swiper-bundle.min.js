!function (e, t) {
    ...
    const B = {
        eventsEmitter: {
            ...
            attachEvents: function () {
                ...
                e.onTouchStart = S.bind(e), e.onTouchMove = M.bind(e), e.onTouchEnd = P.bind(e), s.cssMode && (e.onScroll = L.bind(e)), e.onClick = z.bind(e), i.touch && !O && (t.addEventListener("touchstart", I), O = !0), A(e, "on")
    ...
    const Q = [function (e) {
        ...
        function T() {
            ...
            t.params.scrollbar = Y(t, t.originalParams.scrollbar, t.params.scrollbar, {el: "swiper-scrollbar"});
        ...
        a("beforeInit", (() => {
            ...
            t.params.a11y.enabled && function () {
                let e, s;
                i && i.length > 0 && i.remove(), t.navigation && t.navigation.$nextEl && (e = t.navigation.$nextEl), t.navigation && t.navigation.$prevEl && (s = t.navigation.$prevEl), e && e.off("keydown", m), s && s.off("keydown", m), g() && t.pagination.$el.off("keydown", R(t.params.pagination.bulletClass), m), t.$el.off("focus", x, !0), t.$el.off("pointerdown", w, !0), t.$el.off("pointerup", b, !0)
            }()
        }))
    }, function (e) {
        let {swiper: t, extendParams: s, on: a} = e;
        ...
        let {swiper: t, extendParams: s, on: a} = e;
        s({fadeEffect: {crossFade: !1, transformEl: null}}), F({
            effect: "fade",
            swiper: t,
            on: a,
            setTranslate: () => {
                ...
                for (let a = 0; a < e.length; a += 1) {
                    ...
                    U(s, e).css({opacity: n}).transform(`translate3d(${i}px, ${r}px, 0px)`)
                }
            },
            setTransition: e => {
        ...
        const i = (e, s, a) => {
            ...
            0 === i.length && (i = Z(a, e, t.isHorizontal() ? "left" : "top")), 0 === r.length && (r = Z(a, e, t.isHorizontal() ? "right" : "bottom")), i.length && (i[0].style.opacity = Math.max(-s, 0)), r.length && (r[0].style.opacity = Math.max(s, 0))
        };
        F({
            effect: "flip",
            swiper: t,
        ...
        let {swiper: t, extendParams: s, on: a} = e;
        s({cardsEffect: {slideShadows: !0, transformEl: null, rotate: !0, perSlideRotate: 2, perSlideOffset: 8}}), F({
            effect: "cards",
            swiper: t,
            on: a,
            setTranslate: () => {
                ...
                for (let l = 0; l < e.length; l += 1) {
                    ...
                    o[0].style.zIndex = -Math.abs(Math.round(d)) + e.length, U(a, o).transform(E)
                }
            },
            setTransition: e => {
