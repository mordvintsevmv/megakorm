...
- [X] Сформированы предложения по оптимизации
...
Ввод количества животных в калькуляторе никак не выделяется от общего текста. Невозможно понять, что есть возможность вводить свои данные + не меняется окончание "голов":

![calc-input](readme-img/testing/safari-macos/calc-input.png)
...
11. Ввод количества животных в калькуляторе никак не выделяется от общего текста. Невозможно понять, что есть возможность вводить свои данные. + не меняется окончание "голов".
...
11. И другие мелкие испралвения по перечисленным ошибкам.
...
## Дальнейшие рекомендации по оптимизации сайта будут появляться по мере изучения кода
