...
13. В блоке "О Компании" у ссылки "На сайт Мегамикс" маленькие отсупы слева;
...
**Общие исправления:**
1. (По желанию) Изменить логотип для вкладки на более крупный;
...
4. Добавить email в footer
5. 

**Проблема с анимацией на Safari (блок "Почему стоит выбрать «Мегакорм»"):**

В данном блоке используются файлы формата webp с анимацией. 
